...
<body>
    ...
    <div id='container'>
        ...
        <div id="content">
            ...
            <div id="user_add">
                <div id="user_add_title">Add Regular User</div>
                <div id="user_add_box">
                    <form id="register_form" name="register_form" action="user_add_proc.php" method="post">
                        <div id="email_box">
                        ...
                        <div>
                            ...
                            <input id="user_add_btn" type="submit" value="Add Regular User">
                        </div>
                    </form>
                </div>
            </div>
            <div id="user_import">
                <div id="user_import_title">Import Regular Users</div>
                <div id="user_import_box">
                    <form id="upload_form" name="upload_form" action="user_import_proc.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <input id="user_import_btn" name="user_import_submit" type="submit" value="Import Regular Users" onclick="upload('user.php?currentPage=<?php echo $_REQUEST['currentPage']; ?>');">
                        </div>
                    </form>
                </div>
            </div>
