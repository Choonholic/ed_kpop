...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/storage_upload.css">
...
<body>
    ...
    <div id='container'>
        ...
        <div id="content">
            <div id="storage_title">Storage</div>
            <div id="upload_storage">
                <div class="upload_storage_title">Upload File</div>
                <div id="upload_storage_box">
                    <form id="upload_form" name="upload_form" action="storage_upload_proc.php" method="post" enctype="multipart/form-data">
                        <div id="upload_storage_message">Select File to Upload:</div>
                        <div id="upload_storage_inner_box">
                        ...
                        <div>
                            <input id="upload_storage_btn" name="upload_storage_submit" type="submit" value="Upload" onclick="upload('storage.php?currentPage=<?php echo $_REQUEST['currentPage']; ?>');">
                        </div>
                    </form>
                </div>
            </div>
